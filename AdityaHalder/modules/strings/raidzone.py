...
LOVERAID = [
    ...
    "Dil To Karta Hai Ki Tumse Lipat Kar Tumhe Batau, Kitni Bechaini Hoti Hai Tumse Dur Reh Kar Jeene Mein...🙁",
    "TUMHARE KABIL HU YA",
    "TUMHARE KABIL NHI😂💓",
    ...
    "कभी नजर ना लगे, तुम्हारी इस मुस्कान को। दुनिया की हर खुशी मिले, मेरी जान को।❤️🥰",
    "दिल करता है तुमसे एक बार मिलूं और जी भर के तुमको kiss करूं💋💋",
    "इंतजार हैं मुझे उस रात का जान जब...! तुम मेरी बाहों में आकर कहोगी और कुछ करो ना😍",
]
